...
export default function Page3() {
    ...
    useEffect(() => {
        ...
        // Add GSAP animation for title reveal
        const revealTimeline = gsap.timeline({
            scrollTrigger: {
                trigger: ".reveal-section-page3",
                start: "top 80%",
                toggleActions: "play none none none"
            }
        });

        revealTimeline.to(".reveal-section-page3 .overlay", {
            scaleX: 0,
            duration: 1.2,
            ease: "power4.inOut",
            stagger: 0.2
        })
        .to(".reveal-section-page3 .text-content", {
            y: 0,
            opacity: 1,
            duration: 1.2,
            ease: "power3.out",
    ...
    return (
        <div className="antialiased min-h-screen relative font-sans text-white bg-black overflow-x-hidden">
            ...
            <section className="relative w-full flex flex-col items-center pt-4 pb-8 bg-black mt-12">
                ...
                <div className="flex flex-col items-center text-center font-funnel z-10 w-full max-w-4xl mx-auto mt-20 mb-10 scale-90 sm:scale-100">
        
                    {/* LINE 1 */}
                    <h2 className="text-white font-[800] text-3xl sm:text-4xl md:text-5xl lg:text-6xl tracking-custom leading-[0.85] m-0 whitespace-nowrap uppercase">
                        WE CREATE
                    </h2>
                    
                    {/* LINE 2 */}
                    <div className="relative text-white font-[800] text-3xl sm:text-4xl md:text-5xl lg:text-6xl tracking-custom leading-[0.85] m-0 -mt-1 md:-mt-2 whitespace-nowrap flex items-center justify-center">
                        ...
                        <span className="relative z-10 uppercase ml-[100px] sm:ml-[120px] md:ml-[140px]">THAN</span>
                    </div>
                    
                    {/* LINE 3 */}
                    <h2 className="text-white font-[800] text-5xl sm:text-6xl md:text-7xl lg:text-8xl tracking-custom leading-[0.85] m-0 mt-1 md:mt-2 whitespace-nowrap uppercase">
                        VIDEOS
                    </h2>

                    {/* SUBHEADING */}
                    <p className="font-subheading text-[#D7DFE9] text-sm sm:text-base md:text-lg lg:text-xl mt-6 md:mt-8 max-w-[90%] md:max-w-2xl font-[300] tracking-wide opacity-80 leading-relaxed">
                        <div className="reveal-section-page3">
                            <div className="text-container inline-flex flex-col items-center">
                                <div className="line-wrapper">
                                    <div className="overlay bg-[#fc8019]"></div>
                                    <span className="text-content">We transform real-time moments into <span className="text-white font-[500]">cinematic reels</span> in under 10 minutes.</span>
                                </div>
                            </div>
                        </div>
                    </p>
