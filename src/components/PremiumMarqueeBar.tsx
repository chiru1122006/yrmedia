...
// --- PremiumMarqueeBar Component ---
const PremiumMarqueeBar = () => {
  const itemsCount = 12; // Number of repetitions per track
  const textContent = "10 MIN REEL DELIVERY";
  
  // Create an array to map over for the repeating content
  const repeatedItems = Array(itemsCount).fill(textContent);

  return (
    <div className="marquee-container relative flex w-full h-[50px] md:h-[60px] bg-white overflow-hidden items-center border-y-[3px] border-[#FC8019] shadow-[0_4px_15px_rgba(252,128,25,0.2),0_-4px_15px_rgba(252,128,25,0.2),inset_0_4px_8px_rgba(252,128,25,0.15),inset_0_-4px_8px_rgba(252,128,25,0.15)]">
      ...
      {/* Global Styles injected for Fonts and Keyframes */}
      <style>{`
        ...
        /* Utility class for our premium fonts */
        .font-space {
        ...
        .font-impact {
            ...
            letter-spacing: 0.03em; /* Slight spacing for readability on thick fonts */
        }
        ...
        /* Animated grain/noise texture keyframes */
        @keyframes noise {
...
export default PremiumMarqueeBar;
